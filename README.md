...
- Eleven themes, all free. **Haunted Arcade** is the starting theme on every fresh page load and profile selection. Its original pixel-art courtyard, glowing cabinets, pumpkin lanterns, haunted tower, headphone/witch/pumpkin ghosts, drifting mist and embers extend the seasonal look through navigation, profiles and the guide. Theme changes stay in memory across client-side navigation; a refresh, new visit or profile switch returns to Haunted Arcade. Old saved theme choices are discarded without touching profiles, PINs, favourites or progress. The scenery has no pause button. More > Reduce motion and the device accessibility preference still reduce motion, and the app setting is remembered. Offscreen scenery and hidden tabs pause their animations; system/app reduced motion removes them. **Halloween After Dark** is a separate free, full-page moonlit world with a haunted manor, friendly skeletons, pumpkins, a flying witch and fog. Amber/violet styling continues through navigation, cards, the guide and menus; there is no small After Dark banner. Accounts, payments and saved theme preferences are deferred.
