  ...
  useEffect(() => {
    ...
    async function checkHealth() {
      try {
        ...
        setVersion(data.version?.trim() || "unknown");
      } catch {
        if (cancelled) {
          return;
        }
    ...
    <main className="ttv-ops-screen">
      <section className="ttv-ops-card ttv-launch-hub-card">
        ...
        <div>
          ...
          <p>
            Centralized access to launch validation, health monitoring,
            compatibility checks, backups, recovery tools, and installation
            resources.
          </p>
        </div>
        ...
        <div className="ttv-launch-hub-grid">
          <Link href="/" className="ttv-launch-hub-tile">
            ...
            <small>Return to the live channel experience.</small>
          </Link>

          <Link href="/health" className="ttv-launch-hub-tile">
            <span>Health</span>
            <strong>Production Status</strong>
            <small>Check deployment and API health.</small>
          </Link>

          <Link href="/compat" className="ttv-launch-hub-tile">
            <span>Compatibility</span>
            <strong>Browser Validation</strong>
            <small>
              Test browser features, storage, playback, and PWA support.
            </small>
          </Link>
          ...
          <Link href="/readiness" className="ttv-launch-hub-tile">
            ...
            <small>Review deployment readiness and verification status.</small>
          </Link>

          <Link href="/backup" className="ttv-launch-hub-tile">
            <span>Backup</span>
            <strong>Export / Import</strong>
            <small>Save and restore local application data.</small>
          </Link>

          <Link href="/recovery" className="ttv-launch-hub-tile">
            <span>Recovery</span>
            <strong>Device Recovery</strong>
            <small>Clear broken local state and recover the application.</small>
          </Link>
          ...
          <Link href="/install" className="ttv-launch-hub-tile">
            ...
            <small>
              Install instructions for phones, tablets, desktops, and TVs.
            </small>
          </Link>
          ...
          >
            ...
            <small>Verify install metadata and app configuration.</small>
          </a>
          ...
          >
            ...
            <small>Validate production sitemap output.</small>
          </a>
        </div>

        <div className="ttv-ops-list">
          <strong>Local Smoke Test</strong>
