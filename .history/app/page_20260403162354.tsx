      ...
      <div className="mx-auto flex w-full max-w-[1800px] flex-col gap-3 p-3 sm:p-4">
        ...
        <div
          className={`grid gap-3 ${
            showAdminSidebar ? "lg:grid-cols-[minmax(340px,420px)_minmax(0,1fr)]" : "grid-cols-1"
          }`}
          style={
            showAdminSidebar
              ? {
        ...
        >
          ...
          <section className={`order-1 flex min-w-0 flex-col gap-3 ${showAdminSidebar ? "lg:order-2" : ""}`}>
            ...
            <div className="relative aspect-video w-full overflow-hidden rounded-2xl border border-slate-800 bg-black">
              ...
              {isGuideOpen && (
                <div className="absolute inset-0 z-40 bg-black/80 p-3 sm:p-4 backdrop-blur-[2px]">
