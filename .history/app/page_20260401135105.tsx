    ...
    <main className="min-h-screen bg-slate-950 p-4 text-white">
      <div className="mx-auto max-w-7xl space-y-4">
        ...
        <div className="relative overflow-hidden rounded border border-blue-700 bg-black">
          ...
          {isGuideOpen && (
            <div className="absolute inset-0 z-40 bg-black/70 backdrop-blur-[2px]">
              <div className="grid h-full grid-cols-[minmax(0,1fr)_320px] gap-4 p-4">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="rounded border border-blue-700 bg-[#0a2a4a] p-3 text-sm text-blue-100">
                    <div className="mb-2 text-xs font-semibold uppercase tracking-wide text-blue-200">
                      Controls
                    </div>
                    <div>G = open/close guide</div>
                    <div>↑ / ↓ = move channels</div>
                    <div>Enter / Escape = close guide</div>
                    <div>Mouse hover = preview show</div>
                    <div>Click show = tune channel + close guide</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          {isGuideOpen && hoveredPreview && hoverPreviewStyle ? (
            <div
