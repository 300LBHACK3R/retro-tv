...
export default function Player({ schedule }: PlayerProps) {
      ...
      <div className="flex h-full min-h-[420px] items-center justify-center bg-black text-white">
        <div className="text-center">
          ...
          <div className="mt-1 text-sm text-slate-400">
            Add public MP4 media in admin mode.
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="flex h-full min-h-[420px] items-center justify-center bg-black text-white">
        <div className="text-center">
          ...
          <div className="mt-1 text-sm text-slate-400">
            Use supported public MP4 files or hosted MP4 URLs.
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div
      ref={containerRef}
      className="group relative z-10 h-full min-h-[420px] w-full overflow-hidden rounded-2xl bg-black"
    >
      {!currentItem?.file ? (
