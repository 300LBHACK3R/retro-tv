            ...
            return (
              ...
              >
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  <button
                    onClick={() => assignMediaToChannel(selectedChannelId, item.id)}
                    className="rounded border border-blue-700 bg-[#0d3157] px-2 py-1 text-xs hover:bg-[#174675]"
                  >
                    Add to CH {selectedChannelId}
                  </button>

                  <button
                    onClick={() =>
                      removeMediaFromChannel(selectedChannelId, item.id)
                    }
                    className="rounded border border-blue-700 bg-[#0d3157] px-2 py-1 text-xs hover:bg-[#174675]"
                  >
                    Remove from CH {selectedChannelId}
                  </button>
                </div>
              </div>
            );
